    ...
    _onDragOver: function (evt/**Event*/) {
      if (!_silent && (activeGroup === this.options.group) && (evt.rootEl === void 0 || evt.rootEl === this.el)) {
        var
          ...
          , children = this.options.draggable && el.querySelectorAll(this.options.draggable) || el.children;
        ;
        if (children.length === 0 || children[0] === ghostEl || (el === evt.target) && _ghostInBottom(el, evt)) {
